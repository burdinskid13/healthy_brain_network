...
# features=("features-Teacher-remove-total-scores-spec.json" "features-Parent-remove-total-scores-spec.json" "features-Child-remove-total-scores-spec.json" "features-Parent-SES-spec.json" "features-all-demos-spec.json"  "features-child-anxiety-spec.json" "features-child-cbcl-spec.json" "features-Child-emotional-status-spec.json" "features-Child-executive-function-spec.json" "features-Child-intelligence-spec.json" "features-Child-phonological-spec.json" "features-Child-production-spec.json" "features-Child-reading-spec.json")
features=("features-Child-reading-all-spec.json")
