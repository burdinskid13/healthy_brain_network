...
--participant_specs="['participant_spec20.json', 'participant_spec21.json', 'participant_spec22.json', 'participant_spec23.json', 'participant_spec24.json', 'participant_spec25.json', 'participant_spec26.json', 'participant_spec27.json', 'participant_spec28.json']"
