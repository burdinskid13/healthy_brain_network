...
def firstlevel(feature_spec, target_spec, participant_spec, pydraml_spec, out_dir, cache_dir):
...
def run():
    # define directories
    feature_spec='features-Child-reading-all-spec.json'
    participant_spec="participants-reading-all-Black-spec.json"
    pydraml_spec='pydraml3-spec.json'
    target_spec='target-Diagnosis-Reading-spec.json'
    out_dir = '/om2/user/maedbh/hbn_data/interim/models/reading_august_TEST/'
    cache_dir = None
    ...
    firstlevel(feature_spec, target_spec, participant_spec, pydraml_spec, out_dir=out_dir, cache_dir=cache_dir)
